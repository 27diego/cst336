    ...
    function hint(letter)
    {
        if(letter =="snake")
        {
            alert("An animal with no legs");
        }
        else if(letter =="monkey")
        {
            alert("An animal that walks on two legs");
        }
        else (letter =="beetle")
        {
            alert("A black crawling animal");
        }
        
        //$('#hint').append("<button class='hint-btn' id='hint'>" + Hint + "</button>");
